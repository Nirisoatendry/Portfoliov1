...
const Projects = () => {
  const [toggle,setToggle] = useState("tous");
  return (
    <Container id="projects">
      <Wrapper>
        ...
        <ToogleGroup>
            { toggle === "tous" ? (
          <ToogleButton active value="tous" onClick={()=> setToggle("tous")}>tous</ToogleButton> ) : 
          (
            <ToogleButton onClick={()=> setToggle("tous")}>tous</ToogleButton>
          ) }
          <Divider />
          {toggle === "web app" ? ( 
